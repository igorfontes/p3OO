...
public class Gerencia{
    ...
    public static void addFunc(ArrayList<Funcionario> list){
        ...
        switch(auxtipodefunc){
            ...
            Funcionario auxhorista = new Horista(auxnome, auxendereco, auxtipodefunc, auxmododepagto, auxid, auxidsind, auxtaxasind, 0, auxsalariohora);
            list.add(auxhorista);
            return;
            case "a": 
    ...
    public static void removeFunc(ArrayList<Funcionario> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).getId()==auxremove) {
                System.out.printf("O funcionario %s foi removido com sucesso!\n", list.get(i).getNome());
                list.remove(i);
                return;
            }
        }
    ...
    public static void mudaDados(ArrayList<Funcionario> list) {
        ...
        switch(auxmuda){
            ...
            System.out.printf("Taxa sindical de %.2f.\n",list.get(auxfuncposition).getTaxaSind());
            break;
            case 6:
